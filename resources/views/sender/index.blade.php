    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="{{url('sender/add')}}" class="btn btn-info">Add Sender</a>
          <hr>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <div>
                    <a class="btn btn-success btn-sm" href="{{ url('sender/'.$dt->id) }}">Edit</a>
              ...
              <div class="modal fade" id="delete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form action="{{ url('sender/'.$dt->id) }}" method="post">
                      @csrf
                      {{method_field('delete')}}
                      <div class="modal-body">
                        <p>Are you sure want to delete this sender?</p>
